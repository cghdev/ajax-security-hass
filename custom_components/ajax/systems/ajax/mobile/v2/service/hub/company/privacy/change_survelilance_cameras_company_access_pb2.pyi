...
class ChangeSurveillanceCamerasCompanyAccessRequest(_message.Message):
    ...
    company_id: str
    company_rights: (
        _surveillance_cameras_company_rights_pb2.SurveillanceCamerasCompanyRights
    )
    def __init__(
        self,
        hub_id: str | None = ...,
        company_id: str | None = ...,
        company_rights: _surveillance_cameras_company_rights_pb2.SurveillanceCamerasCompanyRights
        | _Mapping
        | None = ...,
    ) -> None: ...
...
class ChangeSurveillanceCamerasCompanyAccessResponse(_message.Message):
    ...
    error: ChangeSurveillanceCamerasCompanyAccessResponse.Error
    def __init__(
        self,
