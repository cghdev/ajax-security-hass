...
class ConfigMigrationState(_message.Message):
    __slots__ = (
        "data_transfer_state",
        "id",
        "migration_button_devices_state",
        "migration_frame_devices_state",
        "migration_result",
        "object_type",
    )
    ...
    class MigrationFrameDevicesState(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        MIGRATION_FRAME_DEVICES_UNKNOWN_STATE: _ClassVar[
            ConfigMigrationState.MigrationFrameDevicesState
        ]
        MIGRATION_FRAME_DEVICES_NOT_AVAILABLE: _ClassVar[
            ConfigMigrationState.MigrationFrameDevicesState
        ]
        MIGRATION_FRAME_DEVICES_WAITING_FOR_START: _ClassVar[
            ConfigMigrationState.MigrationFrameDevicesState
        ]
        MIGRATION_FRAME_DEVICES_IN_PROGRESS: _ClassVar[
            ConfigMigrationState.MigrationFrameDevicesState
        ]
        MIGRATION_FRAME_DEVICES_FINISHED: _ClassVar[
            ConfigMigrationState.MigrationFrameDevicesState
        ]

    MIGRATION_FRAME_DEVICES_UNKNOWN_STATE: (
        ConfigMigrationState.MigrationFrameDevicesState
    )
    MIGRATION_FRAME_DEVICES_NOT_AVAILABLE: (
        ConfigMigrationState.MigrationFrameDevicesState
    )
    MIGRATION_FRAME_DEVICES_WAITING_FOR_START: (
        ConfigMigrationState.MigrationFrameDevicesState
    )
    ...
    class MigrationButtonDevicesState(
        int, metaclass=_enum_type_wrapper.EnumTypeWrapper
    ):
        __slots__ = ()
        MIGRATION_BUTTON_DEVICES_UNKNOWN_STATE: _ClassVar[
            ConfigMigrationState.MigrationButtonDevicesState
        ]
        MIGRATION_BUTTON_DEVICES_NOT_AVAILABLE: _ClassVar[
            ConfigMigrationState.MigrationButtonDevicesState
        ]
        MIGRATION_BUTTON_DEVICES_WAITING_FOR_START: _ClassVar[
            ConfigMigrationState.MigrationButtonDevicesState
        ]
        MIGRATION_BUTTON_DEVICES_IN_PROGRESS: _ClassVar[
            ConfigMigrationState.MigrationButtonDevicesState
        ]
        MIGRATION_BUTTON_DEVICES_FINISHED: _ClassVar[
            ConfigMigrationState.MigrationButtonDevicesState
        ]

    MIGRATION_BUTTON_DEVICES_UNKNOWN_STATE: (
        ConfigMigrationState.MigrationButtonDevicesState
    )
    MIGRATION_BUTTON_DEVICES_NOT_AVAILABLE: (
        ConfigMigrationState.MigrationButtonDevicesState
    )
    MIGRATION_BUTTON_DEVICES_WAITING_FOR_START: (
        ConfigMigrationState.MigrationButtonDevicesState
    )
    MIGRATION_BUTTON_DEVICES_IN_PROGRESS: (
        ConfigMigrationState.MigrationButtonDevicesState
    )
    ...
    class MigrationResult(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        MIGRATION_RESULT_SERVER_TIMED_OUT: _ClassVar[
            ConfigMigrationState.MigrationResult
        ]
        MIGRATION_RESULT_FINISHED_OK: _ClassVar[ConfigMigrationState.MigrationResult]
        MIGRATION_RESULT_MIGRATION_FAILED: _ClassVar[
            ConfigMigrationState.MigrationResult
        ]
    ...
    def __init__(
        self,
        data_transfer_state: ConfigMigrationState.DataTransferState | str | None = ...,
        migration_frame_devices_state: ConfigMigrationState.MigrationFrameDevicesState
        | str
        | None = ...,
        migration_button_devices_state: ConfigMigrationState.MigrationButtonDevicesState
        | str
        | None = ...,
        migration_result: ConfigMigrationState.MigrationResult | str | None = ...,
        object_type: _object_type_pb2.ObjectType | str | None = ...,
        id: str | None = ...,
    ) -> None: ...
