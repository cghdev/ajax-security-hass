...
class Keypad(_message.Message):
    ...
    def __init__(
        ...
        siren_triggers: _Iterable[Keypad.SirenTrigger | str] | None = ...,
        access_profiles: _Iterable[Keypad.AccessProfile | str] | None = ...,
        star_button_function: Keypad.StarButtonFunction | str | None = ...,
        password: str | None = ...,
        ...
        subtype: Keypad.Subtype | str | None = ...,
    ) -> None: ...
