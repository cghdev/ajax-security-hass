...
class Button(_message.Message):
    ...
    def __init__(
        ...
        siren_triggers: _Iterable[Button.SirenTrigger | str] | None = ...,
        button_mode: Button.ButtonMode | str | None = ...,
        associated_user_id: str | None = ...,
        brightness: Button.Brightness | str | None = ...,
        false_press_filter: Button.FalsePressFilter | str | None = ...,
        custom_alarm_type: Button.CustomAlarmType | str | None = ...,
        subtype: Button.Subtype | str | None = ...,
    ) -> None: ...
