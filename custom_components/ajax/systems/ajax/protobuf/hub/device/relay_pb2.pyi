...
class Relay(_message.Message):
    ...
    def __init__(
        ...
        switch_state: _Iterable[Relay.SwitchState | str] | None = ...,
        actions_on_arming: _Iterable[Relay.ArmActions | str] | None = ...,
        contact_normal_state: Relay.ContactNormalState | str | None = ...,
        lockup_relay_mode: Relay.LockupRelayMode | str | None = ...,
        voltage_milli_volts: _wrappers_pb2.Int32Value | _Mapping | None = ...,
        lockup_relay_time_seconds: int | None = ...,
        subtype: Relay.Subtype | str | None = ...,
    ) -> None: ...
