...
class KeypadCombi(_message.Message):
    ...
    act_on_arming: bool
    act_on_arming_v2: _containers.RepeatedScalarFieldContainer[
        KeypadCombi.BeepOnArmDisarm
    ]
    ...
    def __init__(
        ...
        siren_triggers: _Iterable[KeypadCombi.SirenTrigger | str] | None = ...,
        access_profiles: _Iterable[KeypadCombi.AccessProfile | str] | None = ...,
        star_button_function: KeypadCombi.StarButtonFunction | str | None = ...,
        password: str | None = ...,
        ...
        nfc_enabled: bool = ...,
        beep_on_delay: bool = ...,
        beep_on_delay_v2: _Iterable[KeypadCombi.BeepOnDelay | str] | None = ...,
        siren_events_volume: int | None = ...,
        act_on_arming: bool = ...,
        act_on_arming_v2: _Iterable[KeypadCombi.BeepOnArmDisarm | str] | None = ...,
        time_to_act_seconds: int | None = ...,
        siren_alarm_volume: KeypadCombi.SirenAlarmVolume | str | None = ...,
        chimes_enabled: bool = ...,
        count_protect: int | None = ...,
        buzzer_state: KeypadCombi.BuzzerState | str | None = ...,
        siren_associated_group_id: str | None = ...,
        subtype: KeypadCombi.Subtype | str | None = ...,
    ) -> None: ...
