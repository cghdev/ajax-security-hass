...
class CommonFibraPart(_message.Message):
    ...
    def __init__(
        self,
        bus_number: int | None = ...,
        scan_state: _Iterable[CommonFibraPart.ScanState | str] | None = ...,
        blinking_cmd_state: CommonFibraPart.BlinkingCmdState | str | None = ...,
        max_power_test_result: CommonFibraPart.MaxPowerTestResult | str | None = ...,
    ) -> None: ...
