...
class StreetSirenDoubleDeck(_message.Message):
    ...
    class ArmedLightIndication(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        NO_ARMED_LIGHT_INDICATION_INFO: _ClassVar[
            StreetSirenDoubleDeck.ArmedLightIndication
        ]
    ...
    beep_on_arm_disarm_v2: _containers.RepeatedScalarFieldContainer[
        StreetSirenDoubleDeck.BeepOnArmDisarm
    ]
    ...
    beep_on_delay_v2: _containers.RepeatedScalarFieldContainer[
        StreetSirenDoubleDeck.BeepOnDelay
    ]
    ...
    def __init__(
        ...
        beep_on_arm_disarm: bool = ...,
        beep_on_arm_disarm_v2: _Iterable[StreetSirenDoubleDeck.BeepOnArmDisarm | str]
        | None = ...,
        blink_while_armed: StreetSirenDoubleDeck.ArmedLightIndication
        | str
        | None = ...,
        alert_if_moved: bool = ...,
        siren_volume_level: StreetSirenDoubleDeck.SirenVolumeLevel | str | None = ...,
        externally_powered: _wrappers_pb2.BoolValue | _Mapping | None = ...,
        buzzer_state: StreetSirenDoubleDeck.BuzzerState | str | None = ...,
        beep_on_delay: bool = ...,
        beep_on_delay_v2: _Iterable[StreetSirenDoubleDeck.BeepOnDelay | str]
        | None = ...,
        beep_volume_level: StreetSirenDoubleDeck.BeepVolumeLevel | str | None = ...,
        associated_group_id: str | None = ...,
        chimes_enabled: bool = ...,
        post_alarm_indication_enabled: bool = ...,
        subtype: StreetSirenDoubleDeck.Subtype | str | None = ...,
    ) -> None: ...
