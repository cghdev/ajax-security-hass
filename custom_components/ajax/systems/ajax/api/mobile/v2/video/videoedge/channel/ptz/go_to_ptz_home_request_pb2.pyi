...
class GoToChannelPtzHomeRequest(_message.Message):
...
class GoToChannelPtzHomeResponse(_message.Message):
    ...
    failure: GoToChannelPtzHomeResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: GoToChannelPtzHomeResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
