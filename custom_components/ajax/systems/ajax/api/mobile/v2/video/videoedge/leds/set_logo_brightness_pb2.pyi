...
class SetLogoBrightnessRequest(_message.Message):
    __slots__ = ("brightness", "space_locator", "video_edge_id")
...
class SetLogoBrightnessResponse(_message.Message):
    ...
    failure: SetLogoBrightnessResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: SetLogoBrightnessResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
