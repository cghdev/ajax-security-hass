...
class UpdateFirmwareToRecommendedVersionRequest(_message.Message):
    __slots__ = ("acknowledged_firmware_version", "space_locator", "video_edge_id")
...
class UpdateFirmwareToRecommendedVersionResponse(_message.Message):
    ...
    class Failure(_message.Message):
        __slots__ = (
            "acknowledged_firmware_version_mismatch",
            "bad_request",
            "firmware_update_already_in_progress",
            "no_available_firmware_update",
            "permission_denied",
            "space_armed",
