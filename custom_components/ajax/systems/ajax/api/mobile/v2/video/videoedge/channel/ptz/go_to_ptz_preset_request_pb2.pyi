...
class GoToChannelPtzPresetRequest(_message.Message):
    __slots__ = ("channel_id", "preset_name", "space_locator", "video_edge_id")
...
class GoToChannelPtzPresetResponse(_message.Message):
    ...
    class Failure(_message.Message):
        ...
        PTZ_PRESET_NOT_FOUND_FIELD_NUMBER: _ClassVar[int]
        ...
        ptz_preset_not_found: _response_pb2.DefaultError
        ...
        def __init__(
            ...
            | _Mapping
            | None = ...,
            ptz_preset_not_found: _response_pb2.DefaultError | _Mapping | None = ...,
    ...
    failure: GoToChannelPtzPresetResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: GoToChannelPtzPresetResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
