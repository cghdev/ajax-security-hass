...
class MakeMediaDevicePermanentRequest(_message.Message):
    ...
    media_device_id: str
    name: str
    new_channel: _containers.RepeatedCompositeFieldContainer[
        MakeMediaDevicePermanentRequest.NewChannel
    ]
    ...
    def __init__(
        ...
        name: str | None = ...,
        new_channel: _Iterable[MakeMediaDevicePermanentRequest.NewChannel | _Mapping]
        | None = ...,
...
class MakeMediaDevicePermanentResponse(_message.Message):
    ...
    def __init__(
        ...
        failure: MakeMediaDevicePermanentResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
