...
class RemoveMediaDeviceRequest(_message.Message):
    __slots__ = ("media_device_id", "space_locator", "video_edge_id")
...
class RemoveMediaDeviceResponse(_message.Message):
    ...
    success: RemoveMediaDeviceResponse.Success
    failure: RemoveMediaDeviceResponse.Failure
    def __init__(
        self,
        success: RemoveMediaDeviceResponse.Success | _Mapping | None = ...,
        failure: RemoveMediaDeviceResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
