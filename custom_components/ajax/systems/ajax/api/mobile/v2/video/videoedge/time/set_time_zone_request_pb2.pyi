...
class SetTimeZoneRequest(_message.Message):
    __slots__ = ("space_locator", "timezone_id", "video_edge_id")
...
class SetTimeZoneResponse(_message.Message):
    ...
    class Failure(_message.Message):
        ...
        BAD_TIMEZONE_ID_FIELD_NUMBER: _ClassVar[int]
        VIDEO_EDGE_IS_OFFLINE_FIELD_NUMBER: _ClassVar[int]
        bad_request: _response_pb2.DefaultError
        permission_denied: _response_pb2.DefaultError
        space_armed: _response_pb2.DefaultError
        video_edge_not_found: _response_pb2.DefaultError
        bad_timezone_id: _response_pb2.DefaultError
        ...
        def __init__(
            ...
            bad_timezone_id: _response_pb2.DefaultError | _Mapping | None = ...,
    ...
    failure: SetTimeZoneResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: SetTimeZoneResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
