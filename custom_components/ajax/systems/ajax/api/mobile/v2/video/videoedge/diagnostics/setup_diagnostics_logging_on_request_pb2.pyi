...
class SetDiagnosticsLoggingOnRequest(_message.Message):
    __slots__ = ("logging_settings", "space_locator", "video_edge_id")
    VIDEO_EDGE_ID_FIELD_NUMBER: _ClassVar[int]
    LOGGING_SETTINGS_FIELD_NUMBER: _ClassVar[int]
    SPACE_LOCATOR_FIELD_NUMBER: _ClassVar[int]
    video_edge_id: str
    logging_settings: _diagnostics_settings_pb2.LoggingSettings
...
class SetDiagnosticsLoggingOnResponse(_message.Message):
    ...
    failure: SetDiagnosticsLoggingOnResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: SetDiagnosticsLoggingOnResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
