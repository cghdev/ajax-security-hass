...
class SetArchiveDepthRequest(_message.Message):
    __slots__ = ("max_ring_depth", "space_locator", "video_edge_id")
    VIDEO_EDGE_ID_FIELD_NUMBER: _ClassVar[int]
    MAX_RING_DEPTH_FIELD_NUMBER: _ClassVar[int]
    SPACE_LOCATOR_FIELD_NUMBER: _ClassVar[int]
    video_edge_id: str
    max_ring_depth: _archive_pb2.MaxRingDepth
    space_locator: _space_locator_pb2.SpaceLocator
    def __init__(
        self,
        video_edge_id: str | None = ...,
        max_ring_depth: _archive_pb2.MaxRingDepth | str | None = ...,
...
class SetArchiveDepthResponse(_message.Message):
    ...
    failure: SetArchiveDepthResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: SetArchiveDepthResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
