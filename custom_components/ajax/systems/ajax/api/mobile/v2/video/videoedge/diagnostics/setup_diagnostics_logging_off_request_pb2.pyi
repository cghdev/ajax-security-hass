...
class SetDiagnosticsLoggingOffRequest(_message.Message):
...
class SetDiagnosticsLoggingOffResponse(_message.Message):
    ...
    failure: SetDiagnosticsLoggingOffResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: SetDiagnosticsLoggingOffResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
