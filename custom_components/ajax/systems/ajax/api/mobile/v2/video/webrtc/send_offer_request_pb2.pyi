...
class SendWebRtcOfferRequest(_message.Message):
    __slots__ = (
        "session_description",
        "space_locator",
        "video_edge_id",
...
class SendWebRtcOfferResponse(_message.Message):
    ...
    failure: SendWebRtcOfferResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: SendWebRtcOfferResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
