...
class ArmSpaceGroupRequest(_message.Message):
    __slots__ = ("group_id", "ignore_alarms", "space_locator")
...
class ArmSpaceGroupResponse(_message.Message):
    ...
    failure: ArmSpaceGroupResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: ArmSpaceGroupResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
