...
from systems.ajax.api.mobile.v2.common.space.smartlock import (
    smart_lock_in_space_update_pb2 as _smart_lock_in_space_update_pb2,
)

DESCRIPTOR: _descriptor.FileDescriptor

class UpdateSmartLockRequest(_message.Message):
    __slots__ = ("smart_lock_id", "space_id", "update")
...
class UpdateSmartLockResponse(_message.Message):
    ...
    def __init__(
        ...
        failure: UpdateSmartLockResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
