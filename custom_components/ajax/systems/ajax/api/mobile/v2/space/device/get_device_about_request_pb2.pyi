...
class GetDeviceAboutRequest(_message.Message):
    ...
    qr_code: str
    def __init__(self, qr_code: str | None = ...) -> None: ...

class GetDeviceAboutResponse(_message.Message):
    __slots__ = ("failure", "success")
    class Success(_message.Message):
        __slots__ = ("hub", "hub_device", "video_edge")
        ...
        def __init__(
            self,
            hub: GetDeviceAboutResponse.Hub | _Mapping | None = ...,
            video_edge: GetDeviceAboutResponse.VideoEdge | _Mapping | None = ...,
            hub_device: GetDeviceAboutResponse.HubDevice | _Mapping | None = ...,
        ) -> None: ...

    class Failure(_message.Message):
        __slots__ = ("bad_request", "device_is_already_installed", "device_not_found")
    ...
    class VideoEdge(_message.Message):
        ...
        def __init__(self, about: _about_pb2.About | _Mapping | None = ...) -> None: ...
    ...
    def __init__(
        self,
        success: GetDeviceAboutResponse.Success | _Mapping | None = ...,
        failure: GetDeviceAboutResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
