...
class ArmSpaceToNightModeRequest(_message.Message):
...
class ArmSpaceToNightModeResponse(_message.Message):
    ...
    failure: ArmSpaceToNightModeResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: ArmSpaceToNightModeResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
