...
class UpdateInstallationCompanyPermissionsRequest(_message.Message):
    __slots__ = ("company_hex_id", "space_id", "update")
    class PermissionsUpdate(_message.Message):
        __slots__ = ("hub_permission_patch", "space_permission_patch")
        ...
        space_permission_patch: _containers.RepeatedCompositeFieldContainer[
            UpdateInstallationCompanyPermissionsRequest.PermissionsUpdate.SpacePermissionPatch
        ]
        hub_permission_patch: _containers.RepeatedCompositeFieldContainer[
            UpdateInstallationCompanyPermissionsRequest.PermissionsUpdate.HubPermissionPatch
        ]
        def __init__(
            self,
    ...
    space_id: str
    company_hex_id: str
    update: UpdateInstallationCompanyPermissionsRequest.PermissionsUpdate
    def __init__(
        self,
        space_id: str | None = ...,
...
class UpdateInstallationCompanyPermissionsResponse(_message.Message):
    ...
    failure: UpdateInstallationCompanyPermissionsResponse.Failure
    def __init__(
        self,
