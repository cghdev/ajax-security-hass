...
class PhotoOnDemandCompanyRights(_message.Message):
    __slots__ = ("after_alarm", "always", "disabled", "shared_devices", "when_armed")
    ...
    class PhotoOnDemandDevices(_message.Message):
        ...
        devices: _containers.RepeatedCompositeFieldContainer[
            PhotoOnDemandCompanyRights.PhotoOnDemandDevice
        ]
        def __init__(
            self,
            devices: _Iterable[
                PhotoOnDemandCompanyRights.PhotoOnDemandDevice | _Mapping
            ]
            | None = ...,
        ) -> None: ...
    ...
    class PhotoOnDemandDevice(_message.Message):
        ...
        class PhotoDeviceType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            NO_DEVICE_TYPE_INFO: _ClassVar[
                PhotoOnDemandCompanyRights.PhotoOnDemandDevice.PhotoDeviceType
            ]
            MOTION_CAM: _ClassVar[
                PhotoOnDemandCompanyRights.PhotoOnDemandDevice.PhotoDeviceType
            ]
            MOTION_CAM_OUTDOOR: _ClassVar[
                PhotoOnDemandCompanyRights.PhotoOnDemandDevice.PhotoDeviceType
            ]
            MOTION_CAM_PHOD: _ClassVar[
                PhotoOnDemandCompanyRights.PhotoOnDemandDevice.PhotoDeviceType
            ]
            MOTION_CAM_OUTDOOR_PHOD: _ClassVar[
                PhotoOnDemandCompanyRights.PhotoOnDemandDevice.PhotoDeviceType
            ]
            MOTION_CAM_PHOD_FIBRA: _ClassVar[
                PhotoOnDemandCompanyRights.PhotoOnDemandDevice.PhotoDeviceType
            ]
            MOTION_CAM_OUTDOOR_TWO_FOUR_PHOD: _ClassVar[
                PhotoOnDemandCompanyRights.PhotoOnDemandDevice.PhotoDeviceType
            ]
            MOTION_CAM_HD: _ClassVar[
                PhotoOnDemandCompanyRights.PhotoOnDemandDevice.PhotoDeviceType
            ]
            MOTION_CAM_S_PHOD: _ClassVar[
                PhotoOnDemandCompanyRights.PhotoOnDemandDevice.PhotoDeviceType
            ]
            MOTION_CAM_S_PHOD_AM: _ClassVar[
                PhotoOnDemandCompanyRights.PhotoOnDemandDevice.PhotoDeviceType
            ]
            MOTION_CAM_SUPERIOR_PHOD: _ClassVar[
                PhotoOnDemandCompanyRights.PhotoOnDemandDevice.PhotoDeviceType
            ]
            MOTION_CAM_G3: _ClassVar[
                PhotoOnDemandCompanyRights.PhotoOnDemandDevice.PhotoDeviceType
            ]
            CURTAIN_CAM_OUTDOOR_HM_PHOD: _ClassVar[
                PhotoOnDemandCompanyRights.PhotoOnDemandDevice.PhotoDeviceType
            ]
    ...
    def __init__(
        ...
        | _Mapping
        | None = ...,
        disabled: PhotoOnDemandCompanyRights.Never | _Mapping | None = ...,
        always: PhotoOnDemandCompanyRights.Always | _Mapping | None = ...,
        when_armed: PhotoOnDemandCompanyRights.WhenArmed | _Mapping | None = ...,
        after_alarm: PhotoOnDemandCompanyRights.AfterAlarm | _Mapping | None = ...,
    ) -> None: ...
