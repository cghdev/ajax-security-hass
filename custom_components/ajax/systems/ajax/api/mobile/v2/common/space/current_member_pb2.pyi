...
from systems.ajax.api.mobile.v2.common.video.privacy import (
    request_video_access_available_actions_pb2 as _request_video_access_available_actions_pb2,
)

DESCRIPTOR: _descriptor.FileDescriptor

class CurrentMember(_message.Message):
    __slots__ = ("employee_current_member", "pro_current_member", "user_current_member")
    class UserCurrentMember(_message.Message):
        ...
        def __init__(
            ...
            group_permissions: _Iterable[
                _group_permissions_pb2.GroupPermissions | _Mapping
            ]
            | None = ...,
            video_wall: _video_wall_pb2.VideoWall | _Mapping | None = ...,
            notification_info: CurrentMember.NotificationInfo | _Mapping | None = ...,
            hex_id: str | None = ...,
        ) -> None: ...
    ...
    class ProCurrentMember(_message.Message):
        ...
        def __init__(
            ...
            | None = ...,
            access_rights: CurrentMember.AccessRights | _Mapping | None = ...,
            group_permissions: _Iterable[
                _group_permissions_pb2.GroupPermissions | _Mapping
            ]
            | None = ...,
    ...
    class AccessRights(_message.Message):
        __slots__ = ("access_type", "expiration_timestamp", "full_permissions")
        ...
        def __init__(
            self,
            expiration_timestamp: _timestamp_pb2.Timestamp | _Mapping | None = ...,
            access_type: CurrentMember.AccessRights.AccessType | str | None = ...,
            full_permissions: bool = ...,
        ) -> None: ...

    class EmployeeCurrentMemberAvailableActions(_message.Message):
        __slots__ = (
            "invite_to_space_access",
            "manage_members_access",
            "request_video_access",
            "view_event_photos_access",
        )
    ...
    class ManageMembersAvailableActions(_message.Message):
        __slots__ = ("can_change_member_permissions", "can_change_role")
    ...
    class ViewEventPhotosActions(_message.Message):
        ...
        class CanViewPhoto(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            CAN_VIEW_PHOTO_UNSPECIFIED: _ClassVar[
                CurrentMember.ViewEventPhotosActions.CanViewPhoto
            ]
            CAN_VIEW_PHOTO_ON_DEMAND: _ClassVar[
                CurrentMember.ViewEventPhotosActions.CanViewPhoto
            ]
            CAN_VIEW_PHOTO_BY_ALARM_SCENARIO: _ClassVar[
                CurrentMember.ViewEventPhotosActions.CanViewPhoto
            ]
        ...
        CAN_VIEW_PHOTO_BY_ALARM_SCENARIO: (
            CurrentMember.ViewEventPhotosActions.CanViewPhoto
        )
        CAN_VIEW_PHOTO_FIELD_NUMBER: _ClassVar[int]
        can_view_photo: _containers.RepeatedScalarFieldContainer[
            CurrentMember.ViewEventPhotosActions.CanViewPhoto
        ]
        def __init__(
            self,
            can_view_photo: _Iterable[
                CurrentMember.ViewEventPhotosActions.CanViewPhoto | str
            ]
            | None = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        user_current_member: CurrentMember.UserCurrentMember | _Mapping | None = ...,
        pro_current_member: CurrentMember.ProCurrentMember | _Mapping | None = ...,
        employee_current_member: CurrentMember.EmployeeCurrentMember
        | _Mapping
        | None = ...,
    ) -> None: ...
