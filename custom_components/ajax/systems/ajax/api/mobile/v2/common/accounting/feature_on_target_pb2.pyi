...
class FeatureOnTarget(_message.Message):
    __slots__ = ("dealer", "feature", "reseller")
    ...
    def __init__(
        ...
        reseller: _accounting_company_pb2.AccountingCompany | _Mapping | None = ...,
        dealer: _accounting_company_pb2.AccountingCompany | _Mapping | None = ...,
    ) -> None: ...
