...
class HideShortDisconnectsOnTimeline(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    HIDE_SHORT_DISCONNECTS_ON_TIMELINE_UNSPECIFIED: _ClassVar[
        HideShortDisconnectsOnTimeline
    ]
    HIDE_SHORT_DISCONNECTS_ON_TIMELINE_ENABLED: _ClassVar[
        HideShortDisconnectsOnTimeline
    ]
    HIDE_SHORT_DISCONNECTS_ON_TIMELINE_DISABLED: _ClassVar[
        HideShortDisconnectsOnTimeline
    ]
