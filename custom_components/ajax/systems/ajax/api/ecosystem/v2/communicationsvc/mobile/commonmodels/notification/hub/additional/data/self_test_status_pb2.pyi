...
class SelfTestStatus(_message.Message):
    ...
    defected_sensors: _containers.RepeatedScalarFieldContainer[
        SelfTestStatus.DefectedSensor
    ]
    def __init__(
        self,
        defected_sensors: _Iterable[SelfTestStatus.DefectedSensor | str] | None = ...,
    ) -> None: ...
