...
from systems.ajax.api.ecosystem.v2.hubsvc.commonmodels.device.common import (
    sensitivity_pb2 as _sensitivity_pb2,
)

DESCRIPTOR: _descriptor.FileDescriptor

class SensitivityPart(_message.Message):
    __slots__ = ("capabilities", "sensitivity")
    ...
    class SensitivitySettings(_message.Message):
        ...
        def __init__(
            self, sensitivity: _sensitivity_pb2.Sensitivity | str | None = ...
        ) -> None: ...
    ...
    def __init__(
        self,
        sensitivity: _sensitivity_pb2.Sensitivity | str | None = ...,
        capabilities: _Iterable[SensitivityPart.Capability | str] | None = ...,
    ) -> None: ...
