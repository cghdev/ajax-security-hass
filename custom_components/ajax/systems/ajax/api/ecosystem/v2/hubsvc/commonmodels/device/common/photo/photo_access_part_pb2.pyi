...
class PhotoAccessPart(_message.Message):
    ...
    class SomeoneCanMakePhoto(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        SOMEONE_CAN_MAKE_PHOTO_UNSPECIFIED: _ClassVar[
            PhotoAccessPart.SomeoneCanMakePhoto
        ]
        ...
        SOMEONE_CAN_MAKE_PHOTO_HUB_PHOD_DISABLED: _ClassVar[
            PhotoAccessPart.SomeoneCanMakePhoto
        ]
    ...
    def __init__(
        self,
        someone_can_make_photo: PhotoAccessPart.SomeoneCanMakePhoto | str | None = ...,
    ) -> None: ...
