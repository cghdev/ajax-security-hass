...
class CommonSirenPart(_message.Message):
    __slots__ = (
        "capabilities",
        "common_beep_part",
        "extended_alarm_duration_capability",
        "light_indication",
        "siren_settings",
        "siren_volume_level_capabilities",
    )
    class ExtendedAlarmDuration(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        EXTENDED_ALARM_DURATION_UNSPECIFIED: _ClassVar[
            CommonSirenPart.ExtendedAlarmDuration
        ]
        EXTENDED_ALARM_DURATION_NOT_SUPPORTED: _ClassVar[
            CommonSirenPart.ExtendedAlarmDuration
        ]
        EXTENDED_ALARM_DURATION_RESTRICTED: _ClassVar[
            CommonSirenPart.ExtendedAlarmDuration
        ]
    ...
    class Capabilities(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        CAPABILITIES_EXTENDED_ALARM_DURATION_SSF: _ClassVar[
            CommonSirenPart.Capabilities
        ]
    ...
    class SirenSettings(_message.Message):
        ...
        def __init__(
            ...
            siren_volume_level: CommonSirenPart.SirenVolumeLevel | str | None = ...,
        ) -> None: ...
    ...
    siren_volume_level_capabilities: _containers.RepeatedScalarFieldContainer[
        CommonSirenPart.SirenVolumeLevel
    ]
    ...
    def __init__(
        self,
        siren_settings: CommonSirenPart.SirenSettings | _Mapping | None = ...,
        common_beep_part: _common_beep_part_pb2.CommonBeepPart | _Mapping | None = ...,
        light_indication: _light_indication_pb2.LightIndication | _Mapping | None = ...,
        siren_volume_level_capabilities: _Iterable[
            CommonSirenPart.SirenVolumeLevel | str
        ]
        | None = ...,
        capabilities: _Iterable[CommonSirenPart.Capabilities | str] | None = ...,
        extended_alarm_duration_capability: CommonSirenPart.ExtendedAlarmDuration
        | str
        | None = ...,
    ) -> None: ...
