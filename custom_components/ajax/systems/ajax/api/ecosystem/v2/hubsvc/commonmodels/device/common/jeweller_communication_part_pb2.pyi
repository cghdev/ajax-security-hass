...
class JewellerCommunicationPart(_message.Message):
    ...
    class CommunicationMethod(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        COMMUNICATION_METHOD_UNSPECIFIED: _ClassVar[
            JewellerCommunicationPart.CommunicationMethod
        ]
        COMMUNICATION_METHOD_BUILT_IN: _ClassVar[
            JewellerCommunicationPart.CommunicationMethod
        ]
        COMMUNICATION_METHOD_EXTERNAL: _ClassVar[
            JewellerCommunicationPart.CommunicationMethod
        ]
        COMMUNICATION_METHOD_AUTO_SWITCH: _ClassVar[
            JewellerCommunicationPart.CommunicationMethod
        ]
