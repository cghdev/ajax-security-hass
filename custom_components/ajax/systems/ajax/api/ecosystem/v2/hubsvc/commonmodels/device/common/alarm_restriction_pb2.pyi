...
class AlarmRestriction(_message.Message):
    ...
    class AlarmRestrictionMode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        ALARM_RESTRICTION_MODE_UNSPECIFIED: _ClassVar[
            AlarmRestriction.AlarmRestrictionMode
        ]
        ALARM_RESTRICTION_MODE_ALWAYS: _ClassVar[AlarmRestriction.AlarmRestrictionMode]
        ALARM_RESTRICTION_MODE_IF_ARMED: _ClassVar[
            AlarmRestriction.AlarmRestrictionMode
        ]
    ...
    def __init__(
        ...
        | str
        | None = ...,
        capabilities: _Iterable[AlarmRestriction.Capability | str] | None = ...,
    ) -> None: ...
