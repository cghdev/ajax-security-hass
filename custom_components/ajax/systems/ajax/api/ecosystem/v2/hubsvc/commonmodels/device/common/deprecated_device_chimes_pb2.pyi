...
class DeprecatedDeviceChimes(_message.Message):
    ...
    capabilities: _containers.RepeatedScalarFieldContainer[
        DeprecatedDeviceChimes.Capability
    ]
    def __init__(
        self,
        sound: DeprecatedDeviceChimes.Sound | str | None = ...,
        capabilities: _Iterable[DeprecatedDeviceChimes.Capability | str] | None = ...,
    ) -> None: ...
