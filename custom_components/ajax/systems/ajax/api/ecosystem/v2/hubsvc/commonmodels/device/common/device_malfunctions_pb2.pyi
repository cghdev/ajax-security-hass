...
class DeviceMalfunctions(_message.Message):
    ...
    class Malfunction(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        MALFUNCTION_SIREN_VOLUME_TEST_REQUIRED: _ClassVar[
            DeviceMalfunctions.Malfunction
        ]
        ...
        MALFUNCTION_MICROWAVE_SENSOR_CALIBRATION_ERROR: _ClassVar[
            DeviceMalfunctions.Malfunction
        ]
        ...
        MALFUNCTION_BATTERY_HARDWARE_MALFUNCTION: _ClassVar[
            DeviceMalfunctions.Malfunction
        ]
        ...
        MALFUNCTION_MASKING_SENSOR_CALIBRATION_FAILED: _ClassVar[
            DeviceMalfunctions.Malfunction
        ]
        ...
        MALFUNCTION_BATTERY_FAILS_CHARGE_FULLY: _ClassVar[
            DeviceMalfunctions.Malfunction
        ]
    ...
    def __init__(
        self, malfunctions: _Iterable[DeviceMalfunctions.Malfunction | str] | None = ...
    ) -> None: ...
