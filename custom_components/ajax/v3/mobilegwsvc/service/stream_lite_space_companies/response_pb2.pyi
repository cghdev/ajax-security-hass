...
from v3.mobilegwsvc.commonmodels.company import (
    lite_space_company_pb2 as _lite_space_company_pb2,
)
...
class StreamLiteSpaceCompaniesResponse(_message.Message):
    ...
    class Success(_message.Message):
        ...
        def __init__(
            self,
            snapshot: StreamLiteSpaceCompaniesResponse.Snapshot | _Mapping | None = ...,
            update: StreamLiteSpaceCompaniesResponse.Update | _Mapping | None = ...,
        ) -> None: ...
    ...
    class Update(_message.Message):
        ...
        class UpdateType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            ...
            UPDATE_TYPE_UNSPECIFIED: _ClassVar[
                StreamLiteSpaceCompaniesResponse.Update.UpdateType
            ]
    ...
    class LiteSpaceCompanies(_message.Message):
        ...
        LITE_SPACE_COMPANY_FIELD_NUMBER: _ClassVar[int]
        lite_space_company: _containers.RepeatedCompositeFieldContainer[
            _lite_space_company_pb2.LiteSpaceCompany
        ]
        def __init__(
            self,
            lite_space_company: _Iterable[
                _lite_space_company_pb2.LiteSpaceCompany | _Mapping
            ]
            | None = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        success: StreamLiteSpaceCompaniesResponse.Success | _Mapping | None = ...,
        failure: StreamLiteSpaceCompaniesResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
