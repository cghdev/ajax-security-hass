...
class DeviceCommandBukhoorStartResponse(_message.Message):
    ...
    failure: DeviceCommandBukhoorStartResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: DeviceCommandBukhoorStartResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
