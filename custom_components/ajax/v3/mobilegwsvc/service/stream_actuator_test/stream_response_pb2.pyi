...
class StreamActuatorTestStatusResponse(_message.Message):
    ...
    class AnnunciationTestEndPoint(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        ANNUNCIATION_TEST_END_POINT_UNSPECIFIED: _ClassVar[
            StreamActuatorTestStatusResponse.AnnunciationTestEndPoint
        ]
    ...
    class Success(_message.Message):
        ...
        def __init__(
            self,
            snapshot: StreamActuatorTestStatusResponse.Snapshot | _Mapping | None = ...,
            update: StreamActuatorTestStatusResponse.Update | _Mapping | None = ...,
        ) -> None: ...
    ...
    class TestStateInfo(_message.Message):
        ...
        def __init__(
            ...
            annunciation_test_endpoints: _Iterable[
                StreamActuatorTestStatusResponse.AnnunciationTestEndPoint | str
            ]
            | None = ...,
            status: StreamActuatorTestStatusResponse.StatusTest | str | None = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        success: StreamActuatorTestStatusResponse.Success | _Mapping | None = ...,
        failure: StreamActuatorTestStatusResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
