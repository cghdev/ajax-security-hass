...
class SetVideoEdgeRingButtonBellResponse(_message.Message):
    ...
    failure: SetVideoEdgeRingButtonBellResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: SetVideoEdgeRingButtonBellResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
