...
class FormatVideoCloudArchiveResponse(_message.Message):
    ...
    success: FormatVideoCloudArchiveResponse.Success
    failure: FormatVideoCloudArchiveResponse.Failure
    def __init__(
        self,
        success: FormatVideoCloudArchiveResponse.Success | _Mapping | None = ...,
        failure: FormatVideoCloudArchiveResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
