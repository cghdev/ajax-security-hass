...
class DeviceCommandSelfTestResponse(_message.Message):
    ...
    failure: DeviceCommandSelfTestResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: DeviceCommandSelfTestResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
