...
from v3.mobilegwsvc.commonmodels.video.videoedge.channel.notification import (
    video_notification_settings_pb2 as _video_notification_settings_pb2,
)
...
class SetVideoNotificationSettingsResponse(_message.Message):
    ...
    class Success(_message.Message):
        __slots__ = ("video_notification_settings",)
        VIDEO_NOTIFICATION_SETTINGS_FIELD_NUMBER: _ClassVar[int]
        video_notification_settings: (
            _video_notification_settings_pb2.VideoNotificationSettings
        )
        def __init__(
            self,
            video_notification_settings: _video_notification_settings_pb2.VideoNotificationSettings
            | _Mapping
            | None = ...,
        ) -> None: ...
    ...
    success: SetVideoNotificationSettingsResponse.Success
    failure: SetVideoNotificationSettingsResponse.Failure
    def __init__(
        self,
        success: SetVideoNotificationSettingsResponse.Success | _Mapping | None = ...,
        failure: SetVideoNotificationSettingsResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
