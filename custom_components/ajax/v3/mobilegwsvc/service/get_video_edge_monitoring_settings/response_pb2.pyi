...
class GetVideoEdgeMonitoringSettingsResponse(_message.Message):
    ...
    class Success(_message.Message):
        ...
        zone_number: str
        def __init__(self, zone_number: str | None = ...) -> None: ...
    ...
    def __init__(
        self,
        success: GetVideoEdgeMonitoringSettingsResponse.Success | _Mapping | None = ...,
        failure: GetVideoEdgeMonitoringSettingsResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
