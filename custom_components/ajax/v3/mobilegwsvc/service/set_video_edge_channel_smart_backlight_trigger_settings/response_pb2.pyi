...
class SetVideoEdgeChannelSmartBacklightTriggerSettingsResponse(_message.Message):
    ...
    class Failure(_message.Message):
        ...
        COMMAND_NOT_IMPLEMENTED_FIELD_NUMBER: _ClassVar[int]
        ...
        command_not_implemented: _response_pb2.Error
        def __init__(
            self,
            ...
            command_not_implemented: _response_pb2.Error | _Mapping | None = ...,
        ) -> None: ...

    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    FAILURE_FIELD_NUMBER: _ClassVar[int]
    success: _response_pb2.Success
    failure: SetVideoEdgeChannelSmartBacklightTriggerSettingsResponse.Failure
    def __init__(
        self,
