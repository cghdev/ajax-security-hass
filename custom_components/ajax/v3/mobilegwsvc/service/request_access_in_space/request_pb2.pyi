...
class RequestAccessInSpaceRequest(_message.Message):
    ...
    class TemporaryPermissionsDuration(
        int, metaclass=_enum_type_wrapper.EnumTypeWrapper
    ):
        __slots__ = ()
        TEMPORARY_PERMISSIONS_DURATION_UNSPECIFIED: _ClassVar[
            RequestAccessInSpaceRequest.TemporaryPermissionsDuration
        ]
        TEMPORARY_PERMISSIONS_DURATION_1_HOUR: _ClassVar[
            RequestAccessInSpaceRequest.TemporaryPermissionsDuration
        ]
        TEMPORARY_PERMISSIONS_DURATION_2_HOURS: _ClassVar[
            RequestAccessInSpaceRequest.TemporaryPermissionsDuration
        ]
        TEMPORARY_PERMISSIONS_DURATION_4_HOURS: _ClassVar[
            RequestAccessInSpaceRequest.TemporaryPermissionsDuration
        ]
        TEMPORARY_PERMISSIONS_DURATION_8_HOURS: _ClassVar[
            RequestAccessInSpaceRequest.TemporaryPermissionsDuration
        ]

    TEMPORARY_PERMISSIONS_DURATION_UNSPECIFIED: (
        RequestAccessInSpaceRequest.TemporaryPermissionsDuration
    )
    TEMPORARY_PERMISSIONS_DURATION_1_HOUR: (
        RequestAccessInSpaceRequest.TemporaryPermissionsDuration
    )
    TEMPORARY_PERMISSIONS_DURATION_2_HOURS: (
        RequestAccessInSpaceRequest.TemporaryPermissionsDuration
    )
    TEMPORARY_PERMISSIONS_DURATION_4_HOURS: (
        RequestAccessInSpaceRequest.TemporaryPermissionsDuration
    )
    TEMPORARY_PERMISSIONS_DURATION_8_HOURS: (
        RequestAccessInSpaceRequest.TemporaryPermissionsDuration
    )
    ...
    class RequestedVideoPermissions(_message.Message):
        __slots__ = ("channels", "duration", "permissions")
        CHANNELS_FIELD_NUMBER: _ClassVar[int]
        PERMISSIONS_FIELD_NUMBER: _ClassVar[int]
        DURATION_FIELD_NUMBER: _ClassVar[int]
        channels: _containers.RepeatedCompositeFieldContainer[
            _channel_reference_pb2.ChannelReference
        ]
        ...
        def __init__(
            self,
            channels: _Iterable[_channel_reference_pb2.ChannelReference | _Mapping]
            | None = ...,
