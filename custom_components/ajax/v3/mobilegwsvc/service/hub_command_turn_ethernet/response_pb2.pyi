...
class HubCommandTurnEthernetResponse(_message.Message):
    ...
    failure: HubCommandTurnEthernetResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: HubCommandTurnEthernetResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
