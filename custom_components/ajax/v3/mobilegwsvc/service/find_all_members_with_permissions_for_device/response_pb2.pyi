...
class FindAllMembersWithPermissionsForDeviceResponse(_message.Message):
    ...
    class Success(_message.Message):
        ...
        class SpaceMemberDevicePermissions(_message.Message):
            __slots__ = ("device_permissions", "space_company_id", "space_member_id")
            class SpaceMemberId(_message.Message):
                __slots__ = ("space_member_id",)
                SPACE_MEMBER_ID_FIELD_NUMBER: _ClassVar[int]
                space_member_id: str
                def __init__(self, space_member_id: str | None = ...) -> None: ...

            class SpaceCompanyId(_message.Message):
                __slots__ = ("company_id", "space_member_id")
                SPACE_MEMBER_ID_FIELD_NUMBER: _ClassVar[int]
        ...
        space_member_device_permissions: _containers.RepeatedCompositeFieldContainer[
            FindAllMembersWithPermissionsForDeviceResponse.Success.SpaceMemberDevicePermissions
        ]
        def __init__(
            self,
            space_member_device_permissions: _Iterable[
                FindAllMembersWithPermissionsForDeviceResponse.Success.SpaceMemberDevicePermissions
                | _Mapping
            ]
            | None = ...,
