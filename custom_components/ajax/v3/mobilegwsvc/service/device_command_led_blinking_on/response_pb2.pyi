...
class DeviceCommandLedBlinkingOnResponse(_message.Message):
    ...
    failure: DeviceCommandLedBlinkingOnResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: DeviceCommandLedBlinkingOnResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
