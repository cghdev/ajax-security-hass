...
class HubCommandEn54HubActionResponse(_message.Message):
    ...
    failure: HubCommandEn54HubActionResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: HubCommandEn54HubActionResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
