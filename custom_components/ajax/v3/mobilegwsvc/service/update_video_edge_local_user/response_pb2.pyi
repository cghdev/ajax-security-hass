...
class UpdateVideoEdgeLocalUserResponse(_message.Message):
    ...
    class Failure(_message.Message):
        ...
        def __init__(
            ...
            local_user_not_found: _response_pb2.Error | _Mapping | None = ...,
    ...
    failure: UpdateVideoEdgeLocalUserResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: UpdateVideoEdgeLocalUserResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
