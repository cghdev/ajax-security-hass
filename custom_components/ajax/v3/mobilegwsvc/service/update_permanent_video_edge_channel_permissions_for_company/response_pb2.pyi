...
class UpdatePermanentVideoEdgeChannelPermissionsForCompanyResponse(_message.Message):
    ...
    failure: UpdatePermanentVideoEdgeChannelPermissionsForCompanyResponse.Failure
    def __init__(
        self,
