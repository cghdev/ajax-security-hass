...
class UpdatePermanentVideoEdgeChannelPermissionsResponse(_message.Message):
    __slots__ = ("failure", "success")
    class Failure(_message.Message):
        __slots__ = (
            "assignee_space_member_not_found",
            "bad_request",
            "channel_not_found",
            "permission_denied",
            "space_armed",
        ...
        ASSIGNEE_SPACE_MEMBER_NOT_FOUND_FIELD_NUMBER: _ClassVar[int]
        SPACE_ARMED_FIELD_NUMBER: _ClassVar[int]
        bad_request: _response_pb2.Error
        permission_denied: _response_pb2.Error
        video_edge_not_found: _response_pb2.Error
        channel_not_found: _response_pb2.Error
        assignee_space_member_not_found: _response_pb2.Error
    ...
    failure: UpdatePermanentVideoEdgeChannelPermissionsResponse.Failure
    def __init__(
        self,
