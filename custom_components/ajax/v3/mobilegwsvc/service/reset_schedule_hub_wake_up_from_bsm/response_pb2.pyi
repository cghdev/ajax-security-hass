...
class ResetScheduleHubWakeUpFromBsmResponse(_message.Message):
    __slots__ = ("failure", "success")
    class Failure(_message.Message):
        __slots__ = ("bad_request", "hub_busy", "hub_wrong_state", "permission_denied")
    ...
    failure: ResetScheduleHubWakeUpFromBsmResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: ResetScheduleHubWakeUpFromBsmResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
