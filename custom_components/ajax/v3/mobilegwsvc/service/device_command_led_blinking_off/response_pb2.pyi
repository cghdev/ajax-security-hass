...
class DeviceCommandLedBlinkingOffResponse(_message.Message):
    ...
    failure: DeviceCommandLedBlinkingOffResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: DeviceCommandLedBlinkingOffResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
