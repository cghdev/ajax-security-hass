...
class StreamSpaceMonitoringCompanyResponse(_message.Message):
        ...
        class Update(_message.Message):
            ...
            class UpdateType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                ...
                UPDATE_TYPE_UNSPECIFIED: _ClassVar[
                    StreamSpaceMonitoringCompanyResponse.Success.Update.UpdateType
                ]
    ...
    def __init__(
        self,
        success: StreamSpaceMonitoringCompanyResponse.Success | _Mapping | None = ...,
        failure: StreamSpaceMonitoringCompanyResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
