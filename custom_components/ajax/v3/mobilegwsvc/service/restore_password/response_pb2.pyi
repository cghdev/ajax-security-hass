...
class RestorePasswordResponse(_message.Message):
    ...
    class Success(_message.Message):
        ...
        def __init__(self, expected_token_length: int | None = ...) -> None: ...
    ...
    def __init__(
        self,
        success: RestorePasswordResponse.Success | _Mapping | None = ...,
        failure: RestorePasswordResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
