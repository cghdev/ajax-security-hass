...
class SetVideoEdgeLocalUserPasswordResponse(_message.Message):
    ...
    failure: SetVideoEdgeLocalUserPasswordResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: SetVideoEdgeLocalUserPasswordResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
