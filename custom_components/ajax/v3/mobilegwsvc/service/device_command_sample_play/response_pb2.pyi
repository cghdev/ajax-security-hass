...
class DeviceCommandSamplePlayResponse(_message.Message):
    ...
    failure: DeviceCommandSamplePlayResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: DeviceCommandSamplePlayResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
