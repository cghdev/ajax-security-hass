...
class HubCommandEthernetSettingsResponse(_message.Message):
    ...
    failure: HubCommandEthernetSettingsResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: HubCommandEthernetSettingsResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
