...
class DeviceCommandSoundOffResponse(_message.Message):
    ...
    failure: DeviceCommandSoundOffResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: DeviceCommandSoundOffResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
