...
class RestoreTargetResponse(_message.Message):
    ...
    class Failure(_message.Message):
        ...
        def __init__(
            ...
            subscription_plan_not_found: _response_pb2.Error | _Mapping | None = ...,
            illegal_state: _response_pb2.Error | _Mapping | None = ...,
            target_not_found: _response_pb2.Error | _Mapping | None = ...,
            dealer_did_not_suspend_target: _response_pb2.Error | _Mapping | None = ...,
        ) -> None: ...
    ...
    def __init__(
        ...
        failure: RestoreTargetResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
