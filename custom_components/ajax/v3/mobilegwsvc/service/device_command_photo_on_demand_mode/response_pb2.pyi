...
class DeviceCommandPhotoOnDemandModeResponse(_message.Message):
    ...
    failure: DeviceCommandPhotoOnDemandModeResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: DeviceCommandPhotoOnDemandModeResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
