...
class ResendConfirmationCodesResponse(_message.Message):
    ...
    class Failure(_message.Message):
        __slots__ = (
            "bad_request",
            "cannot_request_confirmation_codes",
    ...
    def __init__(
        self,
        success: ResendConfirmationCodesResponse.Success | _Mapping | None = ...,
        failure: ResendConfirmationCodesResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
