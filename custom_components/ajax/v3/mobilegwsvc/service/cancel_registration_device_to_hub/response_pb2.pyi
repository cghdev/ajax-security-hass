...
class CancelRegistrationDeviceToHubResponse(_message.Message):
    ...
    failure: CancelRegistrationDeviceToHubResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: CancelRegistrationDeviceToHubResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
