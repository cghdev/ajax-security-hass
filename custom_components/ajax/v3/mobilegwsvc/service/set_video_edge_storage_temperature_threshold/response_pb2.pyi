...
class SetVideoEdgeStorageTemperatureThresholdResponse(_message.Message):
    ...
    success: SetVideoEdgeStorageTemperatureThresholdResponse.Success
    failure: SetVideoEdgeStorageTemperatureThresholdResponse.Failure
    def __init__(
        self,
        success: SetVideoEdgeStorageTemperatureThresholdResponse.Success
        | _Mapping
