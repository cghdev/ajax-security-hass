...
class ScheduleServiceSubscriptionDeactivationResponse(_message.Message):
    ...
    success: ScheduleServiceSubscriptionDeactivationResponse.Success
    failure: ScheduleServiceSubscriptionDeactivationResponse.Failure
    def __init__(
        self,
        success: ScheduleServiceSubscriptionDeactivationResponse.Success
        | _Mapping
