...
class DeviceCommandChimesModeResponse(_message.Message):
    ...
    failure: DeviceCommandChimesModeResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: DeviceCommandChimesModeResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
