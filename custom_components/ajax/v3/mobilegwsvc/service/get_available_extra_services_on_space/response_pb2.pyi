...
from v3.mobilegwsvc.commonmodels.accounting import (
    available_extra_service_group_pb2 as _available_extra_service_group_pb2,
)
from v3.mobilegwsvc.commonmodels.accounting import (
...
class GetAvailableExtraServicesOnSpaceResponse(_message.Message):
    ...
    class Success(_message.Message):
        ...
        available_extra_service_groups: _containers.RepeatedCompositeFieldContainer[
            _available_extra_service_group_pb2.AvailableExtraServiceGroup
        ]
        current_context: (
        ...
        def __init__(
            self,
            available_extra_service_groups: _Iterable[
                _available_extra_service_group_pb2.AvailableExtraServiceGroup | _Mapping
            ]
            | None = ...,
    ...
    success: GetAvailableExtraServicesOnSpaceResponse.Success
    failure: GetAvailableExtraServicesOnSpaceResponse.Failure
    def __init__(
        self,
        success: GetAvailableExtraServicesOnSpaceResponse.Success
        | _Mapping
