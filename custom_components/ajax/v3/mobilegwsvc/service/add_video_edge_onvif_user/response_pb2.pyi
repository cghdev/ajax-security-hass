...
class AddVideoEdgeOnvifUserResponse(_message.Message):
    ...
    class Failure(_message.Message):
        ...
        def __init__(
            ...
            onvif_user_limit_exceeded: _response_pb2.Error | _Mapping | None = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        success: AddVideoEdgeOnvifUserResponse.Success | _Mapping | None = ...,
        failure: AddVideoEdgeOnvifUserResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
