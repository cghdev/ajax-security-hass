...
class UpdateSpaceMemberSmsPreferencesRequest(_message.Message):
    ...
    class SmsPreferencesPatch(_message.Message):
        __slots__ = ("enabled", "sms_preference")
        SMS_PREFERENCE_FIELD_NUMBER: _ClassVar[int]
        ENABLED_FIELD_NUMBER: _ClassVar[int]
        sms_preference: (
            _display_member_notification_preferences_pb2.DisplayMemberSmsPreference
        )
        enabled: bool
        def __init__(
            self,
    ...
    hub_id: str
    member_id: str
    sms_preferences_patches: _containers.RepeatedCompositeFieldContainer[
        UpdateSpaceMemberSmsPreferencesRequest.SmsPreferencesPatch
    ]
    def __init__(
        self,
        hub_id: str | None = ...,
        member_id: str | None = ...,
        sms_preferences_patches: _Iterable[
            UpdateSpaceMemberSmsPreferencesRequest.SmsPreferencesPatch | _Mapping
        ]
        | None = ...,
    ) -> None: ...
