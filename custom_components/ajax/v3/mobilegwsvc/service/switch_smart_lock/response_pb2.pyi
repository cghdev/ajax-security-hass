...
class SwitchSmartLockResponse(_message.Message):
    ...
    class Failure(_message.Message):
        ...
        def __init__(
            ...
            smart_lock_not_found: _response_pb2.Error | _Mapping | None = ...,
            external_service_access_denied: _response_pb2.Error | _Mapping | None = ...,
            smart_lock_offline: _response_pb2.Error | _Mapping | None = ...,
        ) -> None: ...
    ...
    def __init__(
        ...
        failure: SwitchSmartLockResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
