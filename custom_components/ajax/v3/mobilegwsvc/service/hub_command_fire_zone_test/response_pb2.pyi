...
class HubCommandFireZoneTestResponse(_message.Message):
    ...
    failure: HubCommandFireZoneTestResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: HubCommandFireZoneTestResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
