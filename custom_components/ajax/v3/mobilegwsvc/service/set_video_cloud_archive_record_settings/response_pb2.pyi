...
class SetVideoCloudArchiveRecordSettingsResponse(_message.Message):
    ...
    class Failure(_message.Message):
        __slots__ = (
            ...
            "space_armed",
            "space_not_found",
            "video_edge_command_not_supported",
        ...
        VIDEO_EDGE_COMMAND_NOT_SUPPORTED_FIELD_NUMBER: _ClassVar[int]
        ...
        video_edge_command_not_supported: _response_pb2.Error
        def __init__(
            self,
    ...
    failure: SetVideoCloudArchiveRecordSettingsResponse.Failure
    def __init__(
        self,
