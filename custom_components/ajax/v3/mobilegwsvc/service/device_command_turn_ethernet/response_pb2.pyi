...
class DeviceCommandTurnEthernetResponse(_message.Message):
    ...
    failure: DeviceCommandTurnEthernetResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: DeviceCommandTurnEthernetResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
