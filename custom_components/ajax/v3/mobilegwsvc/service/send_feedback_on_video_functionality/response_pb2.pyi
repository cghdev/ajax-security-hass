...
class SendFeedbackOnVideoFunctionalityResponse(_message.Message):
    ...
    success: SendFeedbackOnVideoFunctionalityResponse.Success
    failure: SendFeedbackOnVideoFunctionalityResponse.Failure
    def __init__(
        self,
        success: SendFeedbackOnVideoFunctionalityResponse.Success
        | _Mapping
