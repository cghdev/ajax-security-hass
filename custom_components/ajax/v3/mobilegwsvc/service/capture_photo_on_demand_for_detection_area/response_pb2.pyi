...
class CapturePhotoOnDemandForDetectionAreaResponse(_message.Message):
    ...
    success: CapturePhotoOnDemandForDetectionAreaResponse.Success
    failure: CapturePhotoOnDemandForDetectionAreaResponse.Failure
    def __init__(
        self,
        success: CapturePhotoOnDemandForDetectionAreaResponse.Success
        | _Mapping
