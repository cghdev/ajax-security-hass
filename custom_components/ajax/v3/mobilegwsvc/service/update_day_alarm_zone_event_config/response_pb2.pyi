...
class UpdateDayAlarmZoneEventConfigResponse(_message.Message):
    ...
    class Failure(_message.Message):
        ...
        hub_wrong_state: _response_pb2.Error
        def __init__(
            self,
            ...
            hub_wrong_state: _response_pb2.Error | _Mapping | None = ...,
        ) -> None: ...

    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    FAILURE_FIELD_NUMBER: _ClassVar[int]
    success: _response_pb2.Success
    failure: UpdateDayAlarmZoneEventConfigResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: UpdateDayAlarmZoneEventConfigResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
