...
class SetVideoEdgeIntrusionSettingsResponse(_message.Message):
    ...
    failure: SetVideoEdgeIntrusionSettingsResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: SetVideoEdgeIntrusionSettingsResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
