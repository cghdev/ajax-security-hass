...
class StreamFireZoneResponseV2(_message.Message):
    ...
    class Success(_message.Message):
        ...
        class Snapshot(_message.Message):
            ...
            fire_zones: _containers.RepeatedCompositeFieldContainer[
                StreamFireZoneResponseV2.Success.Snapshot.FireZoneSnapshot
            ]
            def __init__(
                self,
                fire_zones: _Iterable[
                    StreamFireZoneResponseV2.Success.Snapshot.FireZoneSnapshot
                    | _Mapping
                ]
                | None = ...,
        ...
        class Updates(_message.Message):
            ...
            updates: _containers.RepeatedCompositeFieldContainer[
                StreamFireZoneResponseV2.Success.Update
            ]
            def __init__(
                self,
                updates: _Iterable[StreamFireZoneResponseV2.Success.Update | _Mapping]
                | None = ...,
            ) -> None: ...
        ...
        class FireZoneState(_message.Message):
            __slots__ = ("device_count", "name")
            NAME_FIELD_NUMBER: _ClassVar[int]
            DEVICE_COUNT_FIELD_NUMBER: _ClassVar[int]
            name: str
            device_count: int
            def __init__(
                self, name: str | None = ..., device_count: int | None = ...
            ) -> None: ...

        class FireAlarmState(_message.Message):
            __slots__ = ("fire_alarm_details", "state")
            class State(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                STATE_UNSPECIFIED: _ClassVar[
                    StreamFireZoneResponseV2.Success.FireAlarmState.State
                ]
                STATE_NOT_IN_ALARM: _ClassVar[
                    StreamFireZoneResponseV2.Success.FireAlarmState.State
                ]
                STATE_IN_ALARM: _ClassVar[
                    StreamFireZoneResponseV2.Success.FireAlarmState.State
                ]
            ...
            class AlarmReason(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                ALARM_REASON_UNSPECIFIED: _ClassVar[
                    StreamFireZoneResponseV2.Success.FireAlarmState.AlarmReason
                ]
                ALARM_REASON_SMOKE: _ClassVar[
                    StreamFireZoneResponseV2.Success.FireAlarmState.AlarmReason
                ]
                ALARM_REASON_TEMP: _ClassVar[
                    StreamFireZoneResponseV2.Success.FireAlarmState.AlarmReason
                ]
                ALARM_REASON_TEMP_DIFF: _ClassVar[
                    StreamFireZoneResponseV2.Success.FireAlarmState.AlarmReason
                ]
                ALARM_REASON_WIRE_INPUT: _ClassVar[
                    StreamFireZoneResponseV2.Success.FireAlarmState.AlarmReason
                ]
                ALARM_REASON_MCP: _ClassVar[
                    StreamFireZoneResponseV2.Success.FireAlarmState.AlarmReason
                ]

            ALARM_REASON_UNSPECIFIED: (
                StreamFireZoneResponseV2.Success.FireAlarmState.AlarmReason
            )
            ALARM_REASON_SMOKE: (
                StreamFireZoneResponseV2.Success.FireAlarmState.AlarmReason
            ...
            ALARM_REASON_TEMP_DIFF: (
                StreamFireZoneResponseV2.Success.FireAlarmState.AlarmReason
            )
            ALARM_REASON_WIRE_INPUT: (
                StreamFireZoneResponseV2.Success.FireAlarmState.AlarmReason
            )
            ALARM_REASON_MCP: (
                StreamFireZoneResponseV2.Success.FireAlarmState.AlarmReason
            ...
            class FireAlarmDetails(_message.Message):
                __slots__ = (
                    "alarm_reason",
                    "alarm_started_device_id_hex",
                    "alarm_started_device_location",
                    "room_id_hex",
                    "start_timestamp",
                )
                ...
                def __init__(
                    ...
                    alarm_started_device_id_hex: str | None = ...,
                    alarm_started_device_location: str | None = ...,
                ) -> None: ...
            ...
            fire_alarm_details: (
                StreamFireZoneResponseV2.Success.FireAlarmState.FireAlarmDetails
            )
            def __init__(
                self,
                state: StreamFireZoneResponseV2.Success.FireAlarmState.State
        ...
        class TestState(_message.Message):
            ...
            class State(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                STATE_UNSPECIFIED: _ClassVar[
                    StreamFireZoneResponseV2.Success.TestState.State
                ]
                STATE_NOT_IN_TEST: _ClassVar[
                    StreamFireZoneResponseV2.Success.TestState.State
                ]
                STATE_IN_TEST: _ClassVar[
                    StreamFireZoneResponseV2.Success.TestState.State
                ]
        ...
        class DisablementState(_message.Message):
            __slots__ = (
                "disablement_count",
                "disablement_parts_state",
                "disablement_zone_state",
            )
            class DisablementPart(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                DISABLEMENT_PART_UNSPECIFIED: _ClassVar[
                    StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
                ]
                DISABLEMENT_PART_SMOKE: _ClassVar[
                    StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
                ]
                DISABLEMENT_PART_TEMP: _ClassVar[
                    StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
                ]
                DISABLEMENT_PART_SOUNDER: _ClassVar[
                    StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
                ]
                DISABLEMENT_PART_VAD: _ClassVar[
                    StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
                ]
                DISABLEMENT_PART_INPUT: _ClassVar[
                    StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
                ]
                DISABLEMENT_PART_OUTPUT: _ClassVar[
                    StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
                ]
                DISABLEMENT_PART_MCP: _ClassVar[
                    StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
                ]

            DISABLEMENT_PART_UNSPECIFIED: (
                StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
            )
            DISABLEMENT_PART_SMOKE: (
                StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
            )
            DISABLEMENT_PART_TEMP: (
                StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
            )
            DISABLEMENT_PART_SOUNDER: (
                StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
            )
            DISABLEMENT_PART_VAD: (
                StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
            )
            DISABLEMENT_PART_INPUT: (
                StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
            )
            DISABLEMENT_PART_OUTPUT: (
                StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
            )
            DISABLEMENT_PART_MCP: (
                StreamFireZoneResponseV2.Success.DisablementState.DisablementPart
            )
            class State(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                STATE_UNSPECIFIED: _ClassVar[
                    StreamFireZoneResponseV2.Success.DisablementState.State
                ]
                STATE_NOT_PRESENT: _ClassVar[
                    StreamFireZoneResponseV2.Success.DisablementState.State
                ]
                STATE_ENABLED: _ClassVar[
                    StreamFireZoneResponseV2.Success.DisablementState.State
                ]
                STATE_PARTIAL_DISABLEMENT: _ClassVar[
                    StreamFireZoneResponseV2.Success.DisablementState.State
                ]
                STATE_FULL_DISABLEMENT: _ClassVar[
                    StreamFireZoneResponseV2.Success.DisablementState.State
                ]
            ...
            STATE_PARTIAL_DISABLEMENT: (
                StreamFireZoneResponseV2.Success.DisablementState.State
            )
            STATE_FULL_DISABLEMENT: (
                StreamFireZoneResponseV2.Success.DisablementState.State
            )
            ...
            disablement_parts_state: _containers.RepeatedCompositeFieldContainer[
                StreamFireZoneResponseV2.Success.DisablementState.DisablementPartState
            ]
            ...
            def __init__(
                ...
                | str
                | None = ...,
                disablement_parts_state: _Iterable[
                    StreamFireZoneResponseV2.Success.DisablementState.DisablementPartState
                    | _Mapping
                ]
                | None = ...,
                disablement_count: int | None = ...,
            ) -> None: ...

        class FaultState(_message.Message):
            __slots__ = ("faults_count", "state")
            class State(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                STATE_UNSPECIFIED: _ClassVar[
                    StreamFireZoneResponseV2.Success.FaultState.State
                ]
                STATE_NOT_IN_FAULT: _ClassVar[
                    StreamFireZoneResponseV2.Success.FaultState.State
                ]
                STATE_IN_FAULT: _ClassVar[
                    StreamFireZoneResponseV2.Success.FaultState.State
                ]
        ...
        def __init__(
            self,
            snapshot: StreamFireZoneResponseV2.Success.Snapshot | _Mapping | None = ...,
            updates: StreamFireZoneResponseV2.Success.Updates | _Mapping | None = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        success: StreamFireZoneResponseV2.Success | _Mapping | None = ...,
        failure: StreamFireZoneResponseV2.Failure | _Mapping | None = ...,
    ) -> None: ...
