...
class UpdateVideoEdgeLineCrossingRuleResponse(_message.Message):
    ...
    class Failure(_message.Message):
        ...
        RULE_NOT_FOUND_FIELD_NUMBER: _ClassVar[int]
        VIDEO_EDGE_IS_OFFLINE_FIELD_NUMBER: _ClassVar[int]
        NAME_ALREADY_EXISTS_FIELD_NUMBER: _ClassVar[int]
        ...
        rule_not_found: _response_pb2.Error
        ...
        def __init__(
            ...
            | _Mapping
            | None = ...,
            rule_not_found: _response_pb2.Error | _Mapping | None = ...,
    ...
    failure: UpdateVideoEdgeLineCrossingRuleResponse.Failure
    def __init__(
        self,
