...
class StreamHubDeviceResponse(_message.Message):
    ...
    class Success(_message.Message):
        ...
        class Snapshot(_message.Message):
            ...
            def __init__(
                self, hub_device: _hub_device_pb2.HubDevice | _Mapping | None = ...
            ) -> None: ...
        ...
        def __init__(
            self,
            snapshot: StreamHubDeviceResponse.Success.Snapshot | _Mapping | None = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        success: StreamHubDeviceResponse.Success | _Mapping | None = ...,
        failure: StreamHubDeviceResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
