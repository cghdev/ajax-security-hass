...
class DeviceCommandSetWalkTestRequest(_message.Message):
    __slots__ = ("activate", "deactivate", "hub_id")
    ...
    def __init__(
        self,
        hub_id: str | None = ...,
        activate: DeviceCommandSetWalkTestRequest.Activate | _Mapping | None = ...,
        deactivate: DeviceCommandSetWalkTestRequest.Deactivate | _Mapping | None = ...,
    ) -> None: ...
