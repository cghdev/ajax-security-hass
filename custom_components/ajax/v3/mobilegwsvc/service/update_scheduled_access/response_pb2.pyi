...
class UpdateScheduledAccessResponse(_message.Message):
    ...
    class Failure(_message.Message):
        ...
        def __init__(
            ...
            schedule_access_not_found: _response_pb2.Error | _Mapping | None = ...,
        ) -> None: ...

    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    FAILURE_FIELD_NUMBER: _ClassVar[int]
    success: _response_pb2.Success
    failure: UpdateScheduledAccessResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: UpdateScheduledAccessResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
