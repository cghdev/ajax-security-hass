...
class FireZoneDisablementCommandResponse(_message.Message):
    ...
    failure: FireZoneDisablementCommandResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: FireZoneDisablementCommandResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
