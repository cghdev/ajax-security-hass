...
class ConnectVideoEdgeToWifiResponse(_message.Message):
    ...
    class Failure(_message.Message):
        ...
        def __init__(
            ...
            network_interface_not_found: _response_pb2.Error | _Mapping | None = ...,
            network_interface_configuration_in_progress: _response_pb2.Error
            | _Mapping
            | None = ...,
            operation_timeout: _response_pb2.Error | _Mapping | None = ...,
            configuration_apply_failed: _response_pb2.Error | _Mapping | None = ...,
    ...
    failure: ConnectVideoEdgeToWifiResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: ConnectVideoEdgeToWifiResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
