...
class DeviceCommandEthernetSettingsResponse(_message.Message):
    ...
    class Failure(_message.Message):
        ...
        NETWORK_SETTINGS_ERROR_FIELD_NUMBER: _ClassVar[int]
        ...
        network_settings_error: _response_pb2.Error
        def __init__(
            self,
            ...
            network_settings_error: _response_pb2.Error | _Mapping | None = ...,
        ) -> None: ...

    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    FAILURE_FIELD_NUMBER: _ClassVar[int]
    success: _response_pb2.Success
    failure: DeviceCommandEthernetSettingsResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: DeviceCommandEthernetSettingsResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
