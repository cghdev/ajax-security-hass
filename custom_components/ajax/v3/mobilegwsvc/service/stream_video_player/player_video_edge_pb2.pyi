...
class PlayerVideoEdge(_message.Message):
    ...
    channels: _containers.RepeatedCompositeFieldContainer[
        _player_channel_pb2.PlayerChannel
    ]
    detectors: _containers.RepeatedCompositeFieldContainer[
        _player_detector_pb2.PlayerDetector
    ]
    storage_devices: _containers.RepeatedCompositeFieldContainer[
        _player_storage_device_pb2.PlayerStorageDevice
    ]
    timezone_id: str
    ...
    def __init__(
        self,
        id: str | None = ...,
        channels: _Iterable[_player_channel_pb2.PlayerChannel | _Mapping] | None = ...,
        detectors: _Iterable[_player_detector_pb2.PlayerDetector | _Mapping]
        | None = ...,
        storage_devices: _Iterable[
            _player_storage_device_pb2.PlayerStorageDevice | _Mapping
        ]
        | None = ...,
        timezone_id: str | None = ...,
        app_settings: _app_settings_pb2.AppSettings | _Mapping | None = ...,
    ) -> None: ...
