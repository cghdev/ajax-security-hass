...
class PlayerChannel(_message.Message):
    ...
    class VideoSettings(_message.Message):
        ...
        def __init__(
            self, main_resolution: _types_pb2.VideoResolution | _Mapping | None = ...
        ) -> None: ...
    ...
    def __init__(
        ...
        | _Mapping
        | None = ...,
        video_capabilities: PlayerChannel.VideoCapabilities | _Mapping | None = ...,
        video_settings: PlayerChannel.VideoSettings | _Mapping | None = ...,
        audio_settings: PlayerChannel.AudioSettings | _Mapping | None = ...,
