...
class EjectVideoEdgeStorageDeviceResponse(_message.Message):
    ...
    class Failure(_message.Message):
        ...
        storage_device_not_found: _response_pb2.Error
        ...
        def __init__(
            ...
            storage_device_not_found: _response_pb2.Error | _Mapping | None = ...,
    ...
    failure: EjectVideoEdgeStorageDeviceResponse.Failure
    def __init__(
        self,
        success: _response_pb2.Success | _Mapping | None = ...,
        failure: EjectVideoEdgeStorageDeviceResponse.Failure | _Mapping | None = ...,
    ) -> None: ...
